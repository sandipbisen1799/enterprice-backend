...
import { signup, login, logout ,getAllUsers,getUserById,updateUser,deleteUser,getAllUserData,blockUser,unblockUser, addUser,getBlockUser, uploadImage ,changePassword, updateProfile ,getAllUser } from "../controllers/auth.controller.js";
...
router.get("/user", auth, authorize("admin"), getAllUser);
